  ...
  theme: {
    ...
    extend: {
      ...
      typography: ({theme}) => ({
        DEFAULT: {
          css: {
            color: 'var(--mmy-text-default)',
            '[class~="lead"]': {
              color: 'var(--mmy-text-secondary)'
            },
            a: {
              color: 'var(--mmy-primary-500)'
            },
            strong: {
              color: 'var(--mmy-text-default)'
            },
            ...
            'ul > li::before': {
              backgroundColor: 'var(--mmy-text-hint)'
            },
            hr: {
              borderColor: 'var(--mmy-border)'
            },
            blockquote: {
              color: 'var(--mmy-text-default)',
              borderLeftColor: 'var(--mmy-border)'
            },
            h1: {
              color: 'var(--mmy-text-default)'
            },
            ...
            thead: {
              color: 'var(--mmy-text-default)',
              borderBottomColor: 'var(--mmy-border)'
            },
            'tbody tr': {
              borderBottomColor: 'var(--mmy-border)'
            },
